...
export default function Header() {
  ...
  return (
    <header className="z-[999] relative">
      ...
      sm:top-6 sm:h-[3.25rem] sm:w-[36rem] sm:rounded-full dark:bg-indigo-950
      dark:border-white dark:bg-opacity-75"
      ...
      py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0'>
        ...
        text-[0.9rem] font-medium text-grat-500 sm:w-[initial] sm:flex-nowrap sm:gap-5'>
            {
                links.map(link => (
                    <motion.li
                    className='h-3/4 flex items-center justify-center relative'
                     ...
                     >
                        <Link 
                          className={clsx(
                            "flex w-full items-center justify-center px-3 py-3 hover:text-indigo-950 transition dark:text-white dark:hover:text-gray-300", {
